...
date:
tags: ["engineering", "tools_and_mcp"]
---
...
**For users**: Check out the extension directory in Claude Desktop's settings to discover and install extensions with one click.

**For enterprises**: Review our [enterprise documentation](https://support.anthropic.com/en/articles/10949351-getting-started-with-model-context-protocol-mcp-on-claude-for-desktop) for deployment options.

We're excited to see what the community builds with Desktop Extensions. For questions, feedback, or to contribute, visit our [GitHub repository](https://github.com/anthropics/dxt).

### Acknowledgements

This article was written by Paul Zabelin with contributions from Mahesh Murag, Justin Spahr-Summers, Adam Jones, Molly Vorwerck, Stuart Ritchie, and Jeremy Fox.